    ...
    return (
        <div>
            <div className='grid grid-cols-1 md:grid-cols-2 text-white'>
                <div className='bg-[#1F2937] text-xl p-8 text-center'>
                ...
                <div className='bg-[#111827] text-center p-8 space-y-4'>
            ...
            <div className='bg-black text-center text-xl text-white p-4'>
